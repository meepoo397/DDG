...
class CFGAdaptiveSamplerV12(SamplerWithClassifier):
    def __init__(
            self,
            net,
            gnet,
    ...
    def sample(self, noise: torch.Tensor, labels: torch.Tensor, seeds: list):
        ...
        w = self.shift_and_scale_curve(original_data, self.min_guidance, self.max_guidance,
                          self.num_steps,  t_steps,
                          self.w_interval_low_sigma, self.w_interval_high_sigma,1.0)
